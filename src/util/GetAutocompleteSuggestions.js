...
const defaultAutocomplete = ['mcdonald"s', 'kfc', 'sushi', 'subway', 'pizza', 'steakhouse', 'korean', 'german', 'french', 'ethiophian', 'arab', 'uzbek', 'greek', 'italian', 'thai', 'vietnamese', 'indian', 'chinese', 'russian', 'mexican', 'american', 'cuban', 'ukranian'];
